#ifndef __STM8S_FLASH_INLINE_H
#define __STM8S_FLASH_INLINE_H

#include "private/stm8s_flash_private.h"
#include "stm8s_flash.h"

/* SDCC patch: for >64kB to pass data to/from inline ASM (SDCC doesn't support
 * far pointers yet) */
 ...
 * @note   is required for >64kB memory space and SDCC, which doesn't yet
 ...
 * @retval None
 */
inline void FLASH_Unlock_inline(FLASH_MemType_TypeDef FLASH_MemType) {
  /* Check parameter */
 ...
 * @retval None
 */
inline void FLASH_Lock_inline(FLASH_MemType_TypeDef FLASH_MemType) {
  /* Check parameter */
  assert_param(IS_MEMORY_TYPE_OK(FLASH_MemType));
 ...
 * @retval None
 */
inline void FLASH_DeInit_inline(void) {
  ...
  (void)FLASH->IAPSR; /* Reading of this register causes the clearing of status
                         flags */
}
 ...
 * @retval None
 */
inline void FLASH_ITConfig_inline(FunctionalState NewState) {
  /* Check parameter */
 ...
 * @retval None
 */
inline void FLASH_EraseByte_inline(uint32_t Address) {
  /* Check parameter */
 ...
 * @retval None
 */
inline void FLASH_ProgramByte_inline(uint32_t Address, uint8_t Data) {
  /* Check parameters */
  assert_param(IS_FLASH_ADDRESS_OK(Address));
 ...
 */
inline uint8_t FLASH_ReadByte_inline(uint32_t Address) {
  /* Check parameter */
  assert_param(IS_FLASH_ADDRESS_OK(Address));
 ...
 * @retval None
 */
inline void FLASH_ProgramWord_inline(uint32_t Address, uint32_t Data) {
  /* Check parameters */
  assert_param(IS_FLASH_ADDRESS_OK(Address));
 ...
 * @retval None
 */
inline void FLASH_ProgramOptionByte_inline(uint16_t Address, uint8_t Data) {
  /* Check parameter */
 ...
 * @retval None
 */
inline void FLASH_EraseOptionByte_inline(uint16_t Address) {
  /* Check parameter */
  assert_param(IS_OPTION_BYTE_ADDRESS_OK(Address));
 ...
 */
inline uint16_t FLASH_ReadOptionByte_inline(uint16_t Address) {
 ...
 * @retval None
 */
inline void FLASH_SetLowPowerMode_inline(FLASH_LPMode_TypeDef FLASH_LPMode) {
  /* Check parameter */
 ...
 */
inline void
FLASH_SetProgrammingTime_inline(FLASH_ProgramTime_TypeDef FLASH_ProgTime) {
  /* Check parameter */
 ...
 */
inline FLASH_LPMode_TypeDef FLASH_GetLowPowerMode_inline(void) {
  return ((FLASH_LPMode_TypeDef)(FLASH->CR1 &
                                 (uint8_t)(FLASH_CR1_HALT | FLASH_CR1_AHALT)));
}
 ...
 */
inline FLASH_ProgramTime_TypeDef FLASH_GetProgrammingTime_inline(void) {
 ...
 */
inline uint32_t FLASH_GetBootSize_inline(void) {
  uint32_t temp = 0;
 ...
 * register.
 */
inline FlagStatus FLASH_GetFlagStatus_inline(FLASH_Flag_TypeDef FLASH_FLAG) {
