#ifndef __STM8S_EXTI_INLINE_H
#define __STM8S_EXTI_INLINE_H
 ...
 * @retval None
 */
inline void EXTI_DeInit_inline(void) {
 ...
 */
inline void
EXTI_SetExtIntSensitivity_inline(EXTI_Port_TypeDef Port,
 ...
 */
inline void
EXTI_SetTLISensitivity_inline(EXTI_TLISensitivity_TypeDef SensitivityValue) {
  /* Check function parameters */
 ...
 * selected port.
 */
inline EXTI_Sensitivity_TypeDef
EXTI_GetExtIntSensitivity_inline(EXTI_Port_TypeDef Port) {
  uint8_t value = 0;
 ...
 */
inline EXTI_TLISensitivity_TypeDef EXTI_GetTLISensitivity_inline(void) {
  uint8_t value = 0;
