#ifndef __STM8S_UART1_INLINE_H
#define __STM8S_UART1_INLINE_H
 ...
 * @retval None
 */
inline void UART1_DeInit_inline(void) {
 ...
 */
inline void
UART1_Init_inline(uint32_t BaudRate, UART1_WordLength_TypeDef WordLength,
  ...
  /* Disable the Transmitter and Receiver before setting the LBCL, CPOL and CPHA
   * bits */
 ...
 * @retval None
 */
inline void UART1_Cmd_inline(FunctionalState NewState) {
  if (NewState != DISABLE) {
    /* UART1 Enable */
 ...
 * @retval None
 */
inline void UART1_ITConfig_inline(UART1_IT_TypeDef UART1_IT,
 ...
 * @retval None
 */
inline void UART1_HalfDuplexCmd_inline(FunctionalState NewState) {
  assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 ...
 * @retval None
 */
inline void UART1_IrDAConfig_inline(UART1_IrDAMode_TypeDef UART1_IrDAMode) {
 ...
 * @retval None
 */
inline void UART1_IrDACmd_inline(FunctionalState NewState) {
  /* Check parameters */
  assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 ...
 * @retval None
 */
inline void UART1_LINBreakDetectionConfig_inline(
 ...
 * @retval None
 */
inline void UART1_LINCmd_inline(FunctionalState NewState) {
  assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 ...
 * @retval None
 */
inline void UART1_SmartCardCmd_inline(FunctionalState NewState) {
  assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 ...
 * @retval None
 */
inline void UART1_SmartCardNACKCmd_inline(FunctionalState NewState) {
  assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 ...
 * @retval None
 */
inline void UART1_WakeUpConfig_inline(UART1_WakeUp_TypeDef UART1_WakeUp) {
 ...
 * @retval None
 */
inline void UART1_ReceiverWakeUpCmd_inline(FunctionalState NewState) {
  assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 ...
 */
inline uint8_t UART1_ReceiveData8_inline(void) { return ((uint8_t)UART1->DR); }
 ...
 * @retval The received data.
 */
inline uint16_t UART1_ReceiveData9_inline(void) {
  uint16_t temp = 0;

  temp = (uint16_t)(((uint16_t)((uint16_t)UART1->CR1 & (uint16_t)UART1_CR1_R8))
                    << 1);
 ...
 * @retval None
 */
inline void UART1_SendData8_inline(uint8_t Data) {
  /* Transmit Data */
  UART1->DR = Data;
}
 ...
 * @retval None
 */
inline void UART1_SendData9_inline(uint16_t Data) {
 ...
 * @retval None
 */
inline void UART1_SendBreak_inline(void) { UART1->CR2 |= UART1_CR2_SBK; }
 ...
 * @retval None
 */
inline void UART1_SetAddress_inline(uint8_t UART1_Address) {
 ...
 * @retval None
 */
inline void UART1_SetGuardTime_inline(uint8_t UART1_GuardTime) {
 ...
 * @retval None
 */
inline void UART1_SetPrescaler_inline(uint8_t UART1_Prescaler) {
 ...
 */
inline FlagStatus UART1_GetFlagStatus_inline(UART1_Flag_TypeDef UART1_FLAG) {
 ...
 * @retval None
 */
inline void UART1_ClearFlag_inline(UART1_Flag_TypeDef UART1_FLAG) {
 ...
 */
inline ITStatus UART1_GetITStatus_inline(UART1_IT_TypeDef UART1_IT) {
 ...
 * @retval None
 */
inline void UART1_ClearITPendingBit_inline(UART1_IT_TypeDef UART1_IT) {
