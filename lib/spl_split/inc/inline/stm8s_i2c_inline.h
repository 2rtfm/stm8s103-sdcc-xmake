#ifndef __STM8_I2C_INLINE_H
#define __STM8_I2C_INLINE_H
 ...
 * @retval None
 */
inline void I2C_DeInit_inline(void) {
 ...
 * @retval None
 */
inline void I2C_Init_inline(uint32_t OutputClockFrequencyHz,
                            uint16_t OwnAddress,
                            I2C_DutyCycle_TypeDef I2C_DutyCycle,
                            I2C_Ack_TypeDef Ack, I2C_AddMode_TypeDef AddMode,
  ...
  I2C->OARL =
      (uint8_t)(AddMode == I2C_ADDMODE_7BIT ? (OwnAddress << 1) : OwnAddress);
  I2C->OARH =
 ...
 * @retval None
 */
inline void I2C_Cmd_inline(FunctionalState NewState) {
 ...
 * @retval None
 */
inline void I2C_GeneralCallCmd_inline(FunctionalState NewState) {
  /* Check function parameters */
  assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 ...
 * @retval None
 */
inline void I2C_GenerateSTART_inline(FunctionalState NewState) {
  /* Check function parameters */
  assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 ...
 * @retval None
 */
inline void I2C_GenerateSTOP_inline(FunctionalState NewState) {
  /* Check function parameters */
  assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 ...
 * @retval None
 */
inline void I2C_SoftwareResetCmd_inline(FunctionalState NewState) {
  /* Check function parameters */
  assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 ...
 * @retval None
 */
inline void I2C_StretchClockCmd_inline(FunctionalState NewState) {
  /* Check function parameters */
  assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 ...
 * @retval None
 */
inline void I2C_AcknowledgeConfig_inline(I2C_Ack_TypeDef Ack) {
  /* Check function parameters */
  assert_param(IS_I2C_ACK_OK(Ack));
 ...
 * @retval None
 */
inline void I2C_ITConfig_inline(I2C_IT_TypeDef I2C_IT,
 ...
 */
inline void
I2C_FastModeDutyCycleConfig_inline(I2C_DutyCycle_TypeDef I2C_DutyCycle) {
  /* Check function parameters */
  assert_param(IS_I2C_DUTYCYCLE_OK(I2C_DutyCycle));
 ...
 */
inline uint8_t I2C_ReceiveData_inline(void) {
 ...
 * @retval None
 */
inline void I2C_Send7bitAddress_inline(uint8_t Address,
 ...
 * @retval None
 */
inline void I2C_SendData_inline(uint8_t Data) {
 ...
 */
inline ErrorStatus I2C_CheckEvent_inline(I2C_Event_TypeDef I2C_Event) {
 ...
 */
inline I2C_Event_TypeDef I2C_GetLastEvent_inline(void) {
 ...
 */
inline FlagStatus I2C_GetFlagStatus_inline(I2C_Flag_TypeDef I2C_Flag) {
  uint8_t tempreg = 0;
  uint8_t regindex = 0;
 ...
 * @retval None
 */
inline void I2C_ClearFlag_inline(I2C_Flag_TypeDef I2C_FLAG) {
  uint16_t flagpos = 0;
  /* Check the parameters */
 ...
 */
inline ITStatus
I2C_GetITStatus_inline(I2C_ITPendingBit_TypeDef I2C_ITPendingBit) {
 ...
 */
inline void
I2C_ClearITPendingBit_inline(I2C_ITPendingBit_TypeDef I2C_ITPendingBit) {
  uint16_t flagpos = 0;
