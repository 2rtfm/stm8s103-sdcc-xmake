#ifndef __STM8S_ADC1_INLINE_H
#define __STM8S_ADC1_INLINE_H
 ...
 * @retval None
 */
inline void ADC1_DeInit_inline(void) {
 ...
 */
inline void
ADC1_Init_inline(ADC1_ConvMode_TypeDef ADC1_ConversionMode,
 ...
 * @retval None
 */
inline void ADC1_Cmd_inline(FunctionalState NewState) {
  /* Check the parameters */
 ...
 * @retval None
 */
inline void ADC1_ScanModeCmd_inline(FunctionalState NewState) {
  /* Check the parameters */
  assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 ...
 * @retval None
 */
inline void ADC1_DataBufferCmd_inline(FunctionalState NewState) {
  /* Check the parameters */
  assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 ...
 * @retval None
 */
inline void ADC1_ITConfig_inline(ADC1_IT_TypeDef ADC1_IT,
 ...
 * @retval None
 */
inline void ADC1_PrescalerConfig_inline(ADC1_PresSel_TypeDef ADC1_Prescaler) {
  /* Check the parameter */
 ...
 * @retval None
 */
inline void ADC1_SchmittTriggerConfig_inline(
    ADC1_SchmittTrigg_TypeDef ADC1_SchmittTriggerChannel,
    FunctionalState NewState) {
  /* Check the parameters */
  assert_param(IS_ADC1_SCHMITTTRIG_OK(ADC1_SchmittTriggerChannel));
 ...
 */
inline void
ADC1_ConversionConfig_inline(ADC1_ConvMode_TypeDef ADC1_ConversionMode,
                             ADC1_Channel_TypeDef ADC1_Channel,
                             ADC1_Align_TypeDef ADC1_Align) {
  /* Check the parameters */
  assert_param(IS_ADC1_CONVERSIONMODE_OK(ADC1_ConversionMode));
 ...
 */
inline void
ADC1_ExternalTriggerConfig_inline(ADC1_ExtTrig_TypeDef ADC1_ExtTrigger,
                                  FunctionalState NewState) {
  /* Check the parameters */
  assert_param(IS_ADC1_EXTTRIG_OK(ADC1_ExtTrigger));
  assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 ...
 */
inline void ADC1_StartConversion_inline(void) { ADC1->CR1 |= ADC1_CR1_ADON; }
 ...
 */
inline uint16_t ADC1_GetConversionValue_inline(void) {
  uint16_t temph = 0;
  uint8_t templ = 0;
 ...
 * @retval None
 */
inline void ADC1_AWDChannelConfig_inline(ADC1_Channel_TypeDef Channel,
                                         FunctionalState NewState) {
  /* Check the parameters */
  assert_param(IS_FUNCTIONALSTATE_OK(NewState));
  ...
  if (Channel < (uint8_t)8) {
    ...
    {
      ADC1->AWCRH &=
          (uint8_t)~(uint8_t)((uint8_t)1 << (uint8_t)(Channel - (uint8_t)8));
    }
  }
}
 ...
 * @retval None
 */
inline void ADC1_SetHighThreshold_inline(uint16_t Threshold) {
 ...
 * @retval None
 */
inline void ADC1_SetLowThreshold_inline(uint16_t Threshold) {
 ...
 * ADC1 conversion finished.
 */
inline uint16_t ADC1_GetBufferValue_inline(uint8_t Buffer) {
  uint16_t temph = 0;
  uint8_t templ = 0;
 ...
 */
inline FlagStatus
ADC1_GetAWDChannelStatus_inline(ADC1_Channel_TypeDef Channel) {
  uint8_t status = 0;
 ...
 */
inline FlagStatus ADC1_GetFlagStatus_inline(ADC1_Flag_TypeDef Flag) {
 ...
 * @retval None
 */
inline void ADC1_ClearFlag_inline(ADC1_Flag_TypeDef Flag) {
  uint8_t temp = 0;
 ...
 */
inline ITStatus ADC1_GetITStatus_inline(ADC1_IT_TypeDef ITPendingBit) {
 ...
 * @retval None
 */
inline void ADC1_ClearITPendingBit_inline(ADC1_IT_TypeDef ITPendingBit) {
  uint8_t temp = 0;
