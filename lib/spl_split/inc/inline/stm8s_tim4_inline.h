#ifndef __STM8S_TIM4_INLINE_H
#define __STM8S_TIM4_INLINE_H
 ...
 * @retval None
 */
inline void TIM4_DeInit_inline(void) {
 ...
 * @retval None
 */
inline void TIM4_TimeBaseInit_inline(TIM4_Prescaler_TypeDef TIM4_Prescaler,
                                     uint8_t TIM4_Period) {
 ...
 * @retval None
 */
inline void TIM4_Cmd_inline(FunctionalState NewState) {
 ...
 * @retval None
 */
inline void TIM4_ITConfig_inline(TIM4_IT_TypeDef TIM4_IT,
 ...
 * @retval None
 */
inline void TIM4_UpdateDisableConfig_inline(FunctionalState NewState) {
  /* Check the parameters */
  assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 ...
 */
inline void
TIM4_UpdateRequestConfig_inline(TIM4_UpdateSource_TypeDef TIM4_UpdateSource) {
  /* Check the parameters */
 ...
 * @retval None
 */
inline void TIM4_SelectOnePulseMode_inline(TIM4_OPMode_TypeDef TIM4_OPMode) {
  /* Check the parameters */
 ...
 */
inline void
TIM4_PrescalerConfig_inline(TIM4_Prescaler_TypeDef Prescaler,
 ...
 * @retval None
 */
inline void TIM4_ARRPreloadConfig_inline(FunctionalState NewState) {
  /* Check the parameters */
  assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 ...
 */
inline void
TIM4_GenerateEvent_inline(TIM4_EventSource_TypeDef TIM4_EventSource) {
  /* Check the parameters */
 ...
 * @retval None
 */
inline void TIM4_SetCounter_inline(uint8_t Counter) {
 ...
 * @retval None
 */
inline void TIM4_SetAutoreload_inline(uint8_t Autoreload) {
 ...
 */
inline uint8_t TIM4_GetCounter_inline(void) {
 ...
 */
inline TIM4_Prescaler_TypeDef TIM4_GetPrescaler_inline(void) {
 ...
 */
inline FlagStatus TIM4_GetFlagStatus_inline(TIM4_FLAG_TypeDef TIM4_FLAG) {
 ...
 * @retval None.
 */
inline void TIM4_ClearFlag_inline(TIM4_FLAG_TypeDef TIM4_FLAG) {
  /* Check the parameters */
  assert_param(IS_TIM4_GET_FLAG_OK(TIM4_FLAG));
 ...
 */
inline ITStatus TIM4_GetITStatus_inline(TIM4_IT_TypeDef TIM4_IT) {
 ...
 * @retval None.
 */
inline void TIM4_ClearITPendingBit_inline(TIM4_IT_TypeDef TIM4_IT) {
  /* Check the parameters */
  assert_param(IS_TIM4_IT_OK(TIM4_IT));
