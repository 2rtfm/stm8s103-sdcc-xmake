#ifndef __STM8S_SPI_INLINE_H
#define __STM8S_SPI_INLINE_H
 ...
 * @retval None
 */
inline void SPI_DeInit_inline(void) {
 ...
 * @retval None
 */
inline void SPI_Init_inline(SPI_FirstBit_TypeDef FirstBit,
 ...
 * @retval None
 */
inline void SPI_Cmd_inline(FunctionalState NewState) {
 ...
 * @retval None
 */
inline void SPI_ITConfig_inline(SPI_IT_TypeDef SPI_IT,
 ...
 * @retval None
 */
inline void SPI_SendData_inline(uint8_t Data) {
 ...
 */
inline uint8_t SPI_ReceiveData_inline(void) {
 ...
 * @retval None
 */
inline void SPI_NSSInternalSoftwareCmd_inline(FunctionalState NewState) {
  /* Check function parameters */
  assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 ...
 * @retval None
 */
inline void SPI_TransmitCRC_inline(void) {
 ...
 * @retval None
 */
inline void SPI_CalculateCRCCmd_inline(FunctionalState NewState) {
  /* Check function parameters */
  assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 ...
 */
inline uint8_t SPI_GetCRC_inline(SPI_CRC_TypeDef SPI_CRC) {
  uint8_t crcreg = 0;
 ...
 */
inline uint8_t SPI_GetCRCPolynomial_inline(void) {
 ...
 */
inline void
SPI_BiDirectionalLineConfig_inline(SPI_Direction_TypeDef SPI_Direction) {
  /* Check function parameters */
 ...
 */
inline FlagStatus SPI_GetFlagStatus_inline(SPI_Flag_TypeDef SPI_FLAG) {
 ...
 * @retval None
 */
inline void SPI_ClearFlag_inline(SPI_Flag_TypeDef SPI_FLAG) {
 ...
 */
inline ITStatus SPI_GetITStatus_inline(SPI_IT_TypeDef SPI_IT) {
 ...
 * @retval None
 */
inline void SPI_ClearITPendingBit_inline(SPI_IT_TypeDef SPI_IT) {
  uint8_t itpos = 0;
