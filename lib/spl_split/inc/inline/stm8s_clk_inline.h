#ifndef __STM8S_CLK_INLINE_H
#define __STM8S_CLK_INLINE_H
 ...
 */
inline void CLK_DeInit_inline(void) {
 ...
 * @retval None
 */
inline void CLK_FastHaltWakeUpCmd_inline(FunctionalState NewState) {
 ...
 * @retval None
 */
inline void CLK_HSECmd_inline(FunctionalState NewState) {
  /* Check the parameters */
  assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 ...
 * @retval None
 */
inline void CLK_HSICmd_inline(FunctionalState NewState) {
  /* Check the parameters */
  assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 ...
 * @retval None
 */
inline void CLK_LSICmd_inline(FunctionalState NewState) {
  /* Check the parameters */
  assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 ...
 * @retval None
 */
inline void CLK_CCOCmd_inline(FunctionalState NewState) {
  /* Check the parameters */
  assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 ...
 * @retval None
 */
inline void CLK_ClockSwitchCmd_inline(FunctionalState NewState) {
  /* Check the parameters */
  assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 ...
 * @retval None
 */
inline void CLK_SlowActiveHaltWakeUpCmd_inline(FunctionalState NewState) {
  /* check the parameters */
  assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 ...
 */
inline void
CLK_PeripheralClockConfig_inline(CLK_Peripheral_TypeDef CLK_Peripheral,
  ...
  if (((uint8_t)CLK_Peripheral & (uint8_t)0x10) == 0x00) {
    if (NewState != DISABLE) {
      ...
      CLK->PCKENR1 |=
          (uint8_t)((uint8_t)1 << ((uint8_t)CLK_Peripheral & (uint8_t)0x0F));
    } else {
 ...
 */
inline ErrorStatus CLK_ClockSwitchConfig_inline(
 ...
 * @retval None
 */
inline void CLK_HSIPrescalerConfig_inline(CLK_Prescaler_TypeDef HSIPrescaler) {
  /* check the parameters */
 ...
 */
inline void CLK_CCOConfig_inline(CLK_Output_TypeDef CLK_CCO) {
  /* check the parameters */
 ...
 * @retval None
 */
inline void CLK_ITConfig_inline(CLK_IT_TypeDef CLK_IT,
                                FunctionalState NewState) {
  /* check the parameters */
  assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 ...
 * @retval None
 */
inline void CLK_SYSCLKConfig_inline(CLK_Prescaler_TypeDef CLK_Prescaler) {
  /* check the parameters */
 ...
 * @retval None
 */
inline void CLK_SWIMConfig_inline(CLK_SWIMDivider_TypeDef CLK_SWIMDivider) {
  /* check the parameters */
 ...
 * @retval None
 */
inline void CLK_ClockSecuritySystemEnable_inline(void) {
  /* Set CSSEN bit */
 ...
 */
inline CLK_Source_TypeDef CLK_GetSYSCLKSource_inline(void) {
 ...
 */
inline uint32_t CLK_GetClockFreq_inline(void) {
 ...
 * @retval None
 */
inline void CLK_AdjustHSICalibrationValue_inline(
 ...
 * @retval None
 */
inline void CLK_SYSCLKEmergencyClear_inline(void) {
 ...
 */
inline FlagStatus CLK_GetFlagStatus_inline(CLK_Flag_TypeDef CLK_FLAG) {
 ...
 */
inline ITStatus CLK_GetITStatus_inline(CLK_IT_TypeDef CLK_IT) {
 ...
 * @retval None
 */
inline void CLK_ClearITPendingBit_inline(CLK_IT_TypeDef CLK_IT) {
  /* check the parameters */
  assert_param(IS_CLK_IT_OK(CLK_IT));
