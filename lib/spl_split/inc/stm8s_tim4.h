...
#define IS_TIM4_PRESCALER_OK(PRESCALER)                                        \
  (((PRESCALER) == TIM4_PRESCALER_1) || ((PRESCALER) == TIM4_PRESCALER_2) ||   \
   ...
   ((PRESCALER) == TIM4_PRESCALER_16) || ((PRESCALER) == TIM4_PRESCALER_32) || \
   ((PRESCALER) == TIM4_PRESCALER_64) || ((PRESCALER) == TIM4_PRESCALER_128))
...
/** TIM4 Flags */
typedef enum { TIM4_FLAG_UPDATE = ((uint8_t)0x01) } TIM4_FLAG_TypeDef;

#define IS_TIM4_GET_FLAG_OK(FLAG) ((FLAG) == TIM4_FLAG_UPDATE)

/** TIM4 interrupt sources */
typedef enum { TIM4_IT_UPDATE = ((uint8_t)0x01) } TIM4_IT_TypeDef;
